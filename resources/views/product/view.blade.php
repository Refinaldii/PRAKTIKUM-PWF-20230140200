                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center justify-between mb-8">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400 mt-0.5 italic">Viewing product #{{ $product->id }}</p>
                            </div>
                        </div>
                    ...
                    <div class="rounded-lg border border-gray-200 dark:border-gray-700 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <div class="flex items-center px-5 py-4">
                            ...
                            <div class="text-sm font-semibold text-gray-900 dark:text-gray-100 uppercase">{{ $product->name }}</div>
                        </div>
                        ...
                        <div class="flex items-center px-5 py-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <span class="text-sm text-gray-800 dark:text-gray-200">{{ $product->user->name ?? '-' }}</span>
                            </div>
                        </div>
